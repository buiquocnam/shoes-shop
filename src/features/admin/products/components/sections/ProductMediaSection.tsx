...
export const ProductMediaSection: React.FC<ProductMediaSectionProps> = ({
    ...
    return (
        <div className="lg:col-span-1">
            <div className="bg-white dark:bg-gray-900 p-6 rounded-xl shadow-sm border border-gray-200 dark:border-gray-800 sticky top-10">
                <div className="flex flex-col gap-6">
                    ...
                    <div>
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    <FormLabel className="text-gray-900 dark:text-gray-100 text-base font-medium leading-normal pb-2 block">
                                        Product Images
                                    </FormLabel>
                                    <FormControl>
                                        <label
                            ...
                            <div className="grid grid-cols-3 sm:grid-cols-4 lg:grid-cols-3 gap-3">
                                {allImages.map((item) => (
                                    <div
                                        ...
                                        className="relative group aspect-square rounded-lg overflow-hidden bg-gray-100 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 hover:border-red-500 dark:hover:border-red-600 transition-all duration-200"
                                    >
                                        <Image
