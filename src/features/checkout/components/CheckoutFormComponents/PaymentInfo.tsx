...
import { PaymentInfo as PaymentInfoType } from '@/features/checkout/types';
import { CREDIT_CARD_BRANDS, PAYMENT_METHOD_IMAGES } from '@/features/checkout/constants/paymentMethods';
