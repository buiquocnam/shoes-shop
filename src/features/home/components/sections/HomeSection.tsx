        ...
        <section className="py-16 bg-surface-light relative bg-primary/5">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                    <div className="mb-10 text-center">
                        <span className="text-primary font-bold tracking-wider uppercase text-sm">Được yêu thích nhất</span>
                        <h2 className="text-3xl md:text-4xl font-extrabold text-gray-900 mt-2">Sản phẩm bán chạy</h2>
                    </div>
